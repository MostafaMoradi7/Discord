...
//        System.out.println(privateChatMessages.get(1).toString());
    ...
    public void createPrivateChatMessages() {
        Statement stmt = null;
        try {
            Connection conn = this.connect();
            System.out.println("Database Opened...\n");
    ...
    //test done
    public int insertNewMessagePrivateChat(PrivateChatMessage privateChatMessage) {
    ...
    public PortableData findPrivateChatMessage(PrivateChat privateChat) {
        ...
        try (Connection conn = this.connect();
            ...
            while (rst.next()) {
                PrivateChatMessage privateChatMessage = new PrivateChatMessage(rst.getInt("id"),privateChat.getChatID(),
                        findUserWithId(rst.getInt("sender")), findUserWithId(rst.getInt("receiver"))
